...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const keys = Object.keys(objetoRetornado.fetchMenu()); // Retorno: { food: {}, drink: {}}
    assert.deepStrictEqual(keys, ['food', 'drink']);
    // TESTE 3: Verifique que o menu passado para a função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // ```
